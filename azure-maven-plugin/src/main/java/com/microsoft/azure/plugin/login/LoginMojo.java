...
public class LoginMojo extends AbstractMojo {
    ...
    public void execute() throws MojoFailureException {
        ...
        try {
            ...
            try {
                previousSubscriptionId = AzureAuthHelper.existsAzureSecretFile() ? AzureAuthHelper.readAzureCredentials().getDefaultSubscription() : null;
            } catch (IOException e) {
                // ignore;
            }
            ...
            if (StringUtils.isNotBlank(previousSubscriptionId)) {
                // save the older subscirption id if it is valid
        ...
        } catch (AzureLoginFailureException | ExecutionException |
